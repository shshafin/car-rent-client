...
export default function AdminDrivingTypePage() {
  ...
  const { isOpen, onOpen, onOpenChange, onClose } = useDisclosure();
    ...
    const [selectedDrivingType, setSelectedDrivingType] = useState<IDrivingType | null>(null);
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold">Driving Type</h1>
        <Button
          color="primary"
          className="rounded"
          onPress={onOpen}>
                ...
                <form
                  ...
                  <div className="space-y-4 border p-4 rounded-xl bg-muted/30">
                    {defaultValues?.options.length ? (
                      defaultValues?.options?.map((field: any, index: number) => (
                        <div
                          key={field}
                          className="flex gap-2 items-center">
                          {/* <FXInput
          ...
          <>
            ...
            <ModalBody>
              <p className="text-sm text-red-500">
                ⚠️ Are you sure you want to delete this driving type? This action cannot be undone.
              </p>
            </ModalBody>
