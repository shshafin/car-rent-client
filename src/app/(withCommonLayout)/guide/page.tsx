    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f0f9ff] to-[#e0f7fa] text-gray-900 font-sans">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-700 mt-4 max-w-2xl mx-auto leading-relaxed font-medium">
        ...
        <div className="bg-white/40 backdrop-blur-lg rounded-2xl shadow-xl p-8 mb-16">
          <h2 className="text-3xl font-extrabold text-indigo-900 mb-6 flex items-center gap-2">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md max-w-3xl mx-auto space-y-4">
            {inputFields.map(([placeholder, Icon], i) => (
              <div
                ...
                key={i}>
                <Icon className="text-indigo-600 mr-3" />
                <input
        ...
        <div className="bg-white/40 backdrop-blur-lg rounded-2xl shadow-xl p-8 mb-16">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md max-w-3xl mx-auto space-y-4">
            ...
            <div className="flex justify-center items-center mt-4">
              <button className="p-4 bg-green-600 text-white font-semibold rounded-md shadow-lg hover:bg-green-800 transition-all duration-300">
                Pay ฿1000 to Confirm
              </button>
            </div>
            <div className="mt-6 text-center text-sm text-gray-600">
              <p className="mb-2">or</p>
              <button className="p-4 bg-indigo-700 text-white font-semibold rounded-md shadow-lg hover:bg-indigo-900 transition-all duration-300">
                Pay Full ฿5000 Now
              </button>
            </div>
          </div>
        ...
        <div className="bg-white/40 backdrop-blur-lg rounded-2xl shadow-xl p-8 mb-16">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto space-y-4">
            {[
              ...
              <div
                className="flex justify-between items-center bg-indigo-100 p-4 rounded-md"
                key={i}>
